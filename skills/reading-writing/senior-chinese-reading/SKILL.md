...
metadata:
  hermes:
    ...
    workflow: "senior_chinese_reading.run"
    category: "reading-writing"
    category_aliases: ["阅读写作", "读写表达", "reading", "writing", "reading-writing"]
    legacy_slugs: []
    install_aliases: ["senior-chinese-reading"]
    stages: ["senior"]
    subjects: ["语文"]
    abilities: ["阅读理解"]
    scenarios: ["高考复习"]
...
- Install Aliases: `senior-chinese-reading`
- Stages: `senior`
- Subjects: `语文`
- Abilities: `阅读理解`
