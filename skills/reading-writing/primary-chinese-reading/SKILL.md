...
description: "小学语文阅读理解 Skill是面向阅读训练的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: primary_chinese_reading.run."
version: "0.5.0"
author: zhongwei
license: MIT
...
小学语文阅读理解 Skill是面向阅读训练的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
