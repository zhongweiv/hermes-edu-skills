...
description: "高中英语写作 Skill是面向高考复习的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: senior_english_writing.run."
version: "0.8.0"
author: zhongwei
license: MIT
...
高中英语写作 Skill是面向高考复习的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
