---
name: "primary-english-reading"
description: "小学英语阅读帮助英语学习者把阅读训练从“做题对答案”升级为读懂文本、找到依据、组织表达和迁移方法，输出可修改、可复盘、可继续练的阅读/写作任务，而不是替用户一次性完成任务。 Workflow: primary_english_reading.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "primary_english_reading.run"
    category: "reading-writing"
    category_aliases: ["阅读写作", "读写表达", "reading", "writing", "reading-writing"]
    legacy_slugs: []
    install_aliases: ["primary-english-reading"]
    stages: ["primary"]
    subjects: ["英语"]
    abilities: ["阅读理解"]
    scenarios: ["阅读训练"]
...
小学英语阅读帮助英语学习者把阅读训练从“做题对答案”升级为读懂文本、找到依据、组织表达和迁移方法，输出可修改、可复盘、可继续练的阅读/写作任务，而不是替用户一次性完成任务。
...
- Install Aliases: `primary-english-reading`
- Stages: `primary`
- Subjects: `英语`
- Abilities: `阅读理解`
