...
description: "初中英语写作帮助英语学习者把英语写作从套模板变成任务回应、结构清楚、句子准确和表达有亮点，输出可修改、可复盘、可继续练的阅读/写作任务，而不是替用户一次性完成任务。 Workflow: junior_english_writing.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "junior_english_writing.run"
    category: "reading-writing"
    category_aliases: ["阅读写作", "读写表达", "reading", "writing", "reading-writing"]
    legacy_slugs: []
    install_aliases: ["junior-english-writing"]
    stages: ["junior"]
    subjects: ["英语"]
    abilities: ["写作"]
    scenarios: ["中考复习"]
...
初中英语写作帮助英语学习者把英语写作从套模板变成任务回应、结构清楚、句子准确和表达有亮点，输出可修改、可复盘、可继续练的阅读/写作任务，而不是替用户一次性完成任务。
...
- Install Aliases: `junior-english-writing`
- Stages: `junior`
- Subjects: `英语`
- Abilities: `写作`
