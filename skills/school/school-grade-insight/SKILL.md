...
description: "年级学情洞察 Skill用于学校测评，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: school_grade_insight.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "学校管理", "学情分析", "学校测评"]
    source: hermes-edu-skills
    workflow: "school_grade_insight.run"
    category: "school"
...
年级学情洞察 Skill用于学校测评，由 Hermes Agent Runtime 按独立 Agent Context 调用。
...
意图：
- `school_grade_insight`
- `学校测评`

示例表达：
- 开始年级学情洞察 Skill
- 帮我安排学校测评
- 根据当前上下文执行年级学情洞察 Skill
