---
name: "senior-history"
description: "高中历史 Skill用于同步巩固、高考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: senior_history.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "历史", "知识记忆", "材料分析", "同步巩固", "高考复习"]
    source: hermes-edu-skills
    workflow: "senior_history.run"
    category: "history"
    stages: ["senior"]
    subjects: ["历史"]
    abilities: ["知识记忆", "材料分析"]
...
高中历史 Skill用于同步巩固、高考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。
