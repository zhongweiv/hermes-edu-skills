...
description: "数据分析 Skill是面向职业技能的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: college_data_analysis.run."
version: "0.5.0"
author: zhongwei
license: MIT
...
数据分析 Skill是面向职业技能的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
