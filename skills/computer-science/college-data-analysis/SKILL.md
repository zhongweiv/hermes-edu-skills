...
description: "数据分析 Skill用于职业技能、项目训练，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: college_data_analysis.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "college", "adult", "计算机", "数据分析", "职业技能", "项目训练"]
...
数据分析 Skill用于职业技能、项目训练，由 Hermes Agent Runtime 按独立 Agent Context 调用。
