...
description: "AI 讲题 Skill是面向课后作业、同步巩固的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: agent_question_explanation.run."
version: "0.2.0"
author: zhongwei
license: MIT
...
AI 讲题 Skill是面向课后作业、同步巩固的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
