...
description: "初中作文 Skill用于写作提升、中考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: junior_chinese_composition.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "junior", "语文", "写作", "写作提升", "中考复习"]
...
初中作文 Skill用于写作提升、中考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。
