...
description: "初中现代文阅读 Skill用于阅读训练、中考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: junior_chinese_modern_reading.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "junior", "语文", "阅读理解", "阅读训练", "中考复习"]
...
初中现代文阅读 Skill用于阅读训练、中考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。
