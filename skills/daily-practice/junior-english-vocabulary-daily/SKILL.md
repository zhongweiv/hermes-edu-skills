---
name: "junior-english-vocabulary-daily"
description: "把初中英语每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕词汇复现、语境理解、拼写准确和句子输出形成当天闭环。 Workflow: junior_english_vocabulary_daily.run."
version: "0.12.0"
author: zhongwei
license: MIT
...
- Install Aliases: `junior-english-vocabulary-daily`
- Stages: `junior`
- Subjects: `英语`
- Abilities: `词汇`
