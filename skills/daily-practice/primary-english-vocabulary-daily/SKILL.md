...
description: "小学英语单词每日练 Skill是面向每日打卡、听写默写的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: primary_english_vocabulary_daily.run."
version: "0.2.0"
author: zhongwei
license: MIT
...
小学英语单词每日练 Skill是面向每日打卡、听写默写的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
