...
metadata:
  hermes:
    tags: ["education", "senior", "地理", "同步巩固", "专项训练", "每日打卡", "同步巩固"]
    source: hermes-edu-skills
    workflow: "senior_geography_quick_practice.run"
    category: "daily-practice"
    category_aliases: ["每日练习", "每日训练", "daily", "practice", "daily-practice"]
    legacy_slugs: []
    install_aliases: ["senior-geography-quick-practice"]
    stages: ["senior"]
    subjects: ["地理"]
    abilities: ["同步巩固", "专项训练"]
    scenarios: ["每日打卡", "同步巩固"]
...
意图：
- `senior_geography_quick_practice`
- `daily_practice`
- `每日打卡`
- `同步巩固`
...
- Install Aliases: `senior-geography-quick-practice`
- Stages: `senior`
- Subjects: `地理`
- Abilities: `同步巩固`, `专项训练`
