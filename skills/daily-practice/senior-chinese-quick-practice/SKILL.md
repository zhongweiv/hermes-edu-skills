---
name: "senior-chinese-quick-practice"
description: "把高中语文每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕字词积累、阅读依据、表达完整度和错字订正形成当天闭环。 Workflow: senior_chinese_quick_practice.run."
version: "0.12.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "语文", "同步巩固", "专项训练", "每日打卡", "同步巩固"]
    source: hermes-edu-skills
    workflow: "senior_chinese_quick_practice.run"
    category: "daily-practice"
    category_aliases: ["每日练习", "每日训练", "daily", "practice", "daily-practice"]
    legacy_slugs: []
    install_aliases: ["senior-chinese-quick-practice"]
    stages: ["senior"]
    subjects: ["语文"]
    abilities: ["同步巩固", "专项训练"]
    scenarios: ["每日打卡", "同步巩固"]
...
把高中语文每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕字词积累、阅读依据、表达完整度和错字订正形成当天闭环。
...
- Install Aliases: `senior-chinese-quick-practice`
- Stages: `senior`
- Subjects: `语文`
- Abilities: `同步巩固`, `专项训练`
