---
name: "senior-physics-quick-practice"
description: "把高中物理每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念辨析、模型条件、图像/实验信息和推理步骤形成当天闭环。 Workflow: senior_physics_quick_practice.run."
version: "0.12.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "物理", "同步巩固", "专项训练", "每日打卡", "同步巩固"]
    source: hermes-edu-skills
    workflow: "senior_physics_quick_practice.run"
    category: "daily-practice"
    category_aliases: ["每日练习", "每日训练", "daily", "practice", "daily-practice"]
    legacy_slugs: []
    install_aliases: ["senior-physics-quick-practice"]
    stages: ["senior"]
    subjects: ["物理"]
    abilities: ["同步巩固", "专项训练"]
    scenarios: ["每日打卡", "同步巩固"]
...
把高中物理每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念辨析、模型条件、图像/实验信息和推理步骤形成当天闭环。
...
- Install Aliases: `senior-physics-quick-practice`
- Stages: `senior`
- Subjects: `物理`
- Abilities: `同步巩固`, `专项训练`
