---
name: "senior-english-quick-practice"
description: "把高中英语每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕词汇复现、语境理解、拼写准确和句子输出形成当天闭环。 Workflow: senior_english_quick_practice.run."
version: "0.12.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "英语", "同步巩固", "专项训练", "每日打卡", "同步巩固"]
    source: hermes-edu-skills
    workflow: "senior_english_quick_practice.run"
    category: "daily-practice"
    category_aliases: ["每日练习", "每日训练", "daily", "practice", "daily-practice"]
    legacy_slugs: []
    install_aliases: ["senior-english-quick-practice"]
    stages: ["senior"]
    subjects: ["英语"]
    abilities: ["同步巩固", "专项训练"]
    scenarios: ["每日打卡", "同步巩固"]
...
- 高中英语今天练同步巩固，只有 15 分钟，帮我安排。
- 孩子英语最近错在同步巩固，先诊断再做 5 道短练。
...
- Install Aliases: `senior-english-quick-practice`
- Stages: `senior`
- Subjects: `英语`
- Abilities: `同步巩固`, `专项训练`
