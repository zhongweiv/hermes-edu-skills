...
description: "小学语文字词听写 Skill是面向听写默写、每日打卡的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: primary_chinese_dictation_daily.run."
version: "0.2.0"
author: zhongwei
license: MIT
...
小学语文字词听写 Skill是面向听写默写、每日打卡的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
