---
name: "junior-politics-quick-practice"
description: "把初中政治每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念理解、材料提取、观点组织和规范表达形成当天闭环。 Workflow: junior_politics_quick_practice.run."
version: "0.12.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "junior", "政治", "同步巩固", "专项训练", "每日打卡", "同步巩固"]
    source: hermes-edu-skills
    workflow: "junior_politics_quick_practice.run"
    category: "daily-practice"
    category_aliases: ["每日练习", "每日训练", "daily", "practice", "daily-practice"]
    legacy_slugs: []
    install_aliases: ["junior-politics-quick-practice"]
    stages: ["junior"]
    subjects: ["政治"]
    abilities: ["同步巩固", "专项训练"]
    scenarios: ["每日打卡", "同步巩固"]
...
把初中政治每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念理解、材料提取、观点组织和规范表达形成当天闭环。
...
- 先确认主题概念、材料情境和题目要求
- 用概念判断、材料关键词提取和小段表达组成训练
- 反馈要看观点是否贴材料、表达是否有层次
- 把易混概念和表达框架放入下一次材料题复现
...
- 初中政治今天练同步巩固，只有 15 分钟，帮我安排。
- 孩子政治最近错在同步巩固，先诊断再做 5 道短练。
...
意图：
- `junior_politics_quick_practice`
- `daily_practice`
- `每日打卡`
- `同步巩固`
...
- Install Aliases: `junior-politics-quick-practice`
- Stages: `junior`
- Subjects: `政治`
- Abilities: `同步巩固`, `专项训练`
