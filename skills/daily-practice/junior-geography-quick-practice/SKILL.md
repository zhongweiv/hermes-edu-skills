---
name: "junior-geography-quick-practice"
description: "把初中地理每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕地图判读、区域特征、成因解释和图表信息形成当天闭环。 Workflow: junior_geography_quick_practice.run."
version: "0.12.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "junior", "地理", "同步巩固", "专项训练", "每日打卡", "同步巩固"]
...
把初中地理每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕地图判读、区域特征、成因解释和图表信息形成当天闭环。
...
意图：
- `junior_geography_quick_practice`
- `daily_practice`
- `每日打卡`
- `同步巩固`
