...
description: "初中语文快速巩固 Skill是面向每日打卡、同步巩固的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: junior_chinese_quick_practice.run."
version: "0.7.0"
author: zhongwei
license: MIT
...
初中语文快速巩固 Skill是面向每日打卡、同步巩固的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
