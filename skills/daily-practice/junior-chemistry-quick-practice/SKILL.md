---
name: "junior-chemistry-quick-practice"
description: "把初中化学每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念辨析、实验现象、化学用语和反应规律形成当天闭环。 Workflow: junior_chemistry_quick_practice.run."
version: "0.12.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "junior", "化学", "同步巩固", "专项训练", "每日打卡", "同步巩固"]
    source: hermes-edu-skills
    workflow: "junior_chemistry_quick_practice.run"
    category: "daily-practice"
    category_aliases: ["每日练习", "每日训练", "daily", "practice", "daily-practice"]
    legacy_slugs: []
    install_aliases: ["junior-chemistry-quick-practice"]
    stages: ["junior"]
    subjects: ["化学"]
    abilities: ["同步巩固", "专项训练"]
    scenarios: ["每日打卡", "同步巩固"]
...
把初中化学每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念辨析、实验现象、化学用语和反应规律形成当天闭环。
...
- 先确认今天练的是物质性质、方程式、实验还是计算
- 把宏观现象、微观解释和符号表达放在同一组短练里
- 反馈要指出现象描述、方程式或推断链条的具体错误
- 把易混概念和反应条件安排为下一次判断题复现
...
- 初中化学今天练同步巩固，只有 15 分钟，帮我安排。
- 孩子化学最近错在同步巩固，先诊断再做 5 道短练。
...
意图：
- `junior_chemistry_quick_practice`
- `daily_practice`
- `每日打卡`
- `同步巩固`
...
- Install Aliases: `junior-chemistry-quick-practice`
- Stages: `junior`
- Subjects: `化学`
- Abilities: `同步巩固`, `专项训练`
