---
name: "senior-chemistry-quick-practice"
description: "把高中化学每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念辨析、实验现象、化学用语和反应规律形成当天闭环。 Workflow: senior_chemistry_quick_practice.run."
version: "0.12.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "化学", "同步巩固", "专项训练", "每日打卡", "同步巩固"]
    source: hermes-edu-skills
    workflow: "senior_chemistry_quick_practice.run"
    category: "daily-practice"
    category_aliases: ["每日练习", "每日训练", "daily", "practice", "daily-practice"]
    legacy_slugs: []
    install_aliases: ["senior-chemistry-quick-practice"]
    stages: ["senior"]
    subjects: ["化学"]
    abilities: ["同步巩固", "专项训练"]
    scenarios: ["每日打卡", "同步巩固"]
...
把高中化学每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念辨析、实验现象、化学用语和反应规律形成当天闭环。
...
意图：
- `senior_chemistry_quick_practice`
- `daily_practice`
- `每日打卡`
- `同步巩固`
...
- Install Aliases: `senior-chemistry-quick-practice`
- Stages: `senior`
- Subjects: `化学`
- Abilities: `同步巩固`, `专项训练`
