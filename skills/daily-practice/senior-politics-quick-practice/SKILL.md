---
name: "senior-politics-quick-practice"
description: "把高中政治每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念理解、材料提取、观点组织和规范表达形成当天闭环。 Workflow: senior_politics_quick_practice.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "senior_politics_quick_practice.run"
    category: "daily-practice"
    category_aliases: ["每日练习", "每日训练", "daily", "practice", "daily-practice"]
    legacy_slugs: []
    install_aliases: ["senior-politics-quick-practice"]
    stages: ["senior"]
    subjects: ["政治"]
    abilities: ["同步巩固", "专项训练"]
    scenarios: ["每日打卡", "同步巩固"]
...
把高中政治每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕概念理解、材料提取、观点组织和规范表达形成当天闭环。
...
意图：
- `senior_politics_quick_practice`
- `daily_practice`
- `每日打卡`
- `同步巩固`
...
- Install Aliases: `senior-politics-quick-practice`
- Stages: `senior`
- Subjects: `政治`
- Abilities: `同步巩固`, `专项训练`
