---
name: "senior-history-quick-practice"
description: "把高中历史每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕时间线、事件因果、材料信息和观点表达形成当天闭环。 Workflow: senior_history_quick_practice.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "历史", "同步巩固", "专项训练", "每日打卡", "同步巩固"]
    source: hermes-edu-skills
    workflow: "senior_history_quick_practice.run"
    category: "daily-practice"
    category_aliases: ["每日练习", "每日训练", "daily", "practice", "daily-practice"]
    legacy_slugs: []
    install_aliases: ["senior-history-quick-practice"]
    stages: ["senior"]
    subjects: ["历史"]
    abilities: ["同步巩固", "专项训练"]
    scenarios: ["每日打卡", "同步巩固"]
...
把高中历史每日打卡做成 10-15 分钟可坚持、可反馈、可复现的短训练。重点不是多刷题，而是围绕时间线、事件因果、材料信息和观点表达形成当天闭环。
...
- Install Aliases: `senior-history-quick-practice`
- Stages: `senior`
- Subjects: `历史`
- Abilities: `同步巩固`, `专项训练`
