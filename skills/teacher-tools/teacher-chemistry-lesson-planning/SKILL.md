...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "化学", "教学设计", "老师备课"]
    source: hermes-edu-skills
    workflow: "teacher_chemistry_lesson_planning.run"
    category: "teacher-tools"
    category_aliases: ["教师与机构", "老师工具", "教师工具", "teacher-tools", "teaching"]
    legacy_slugs: []
    install_aliases: ["teacher-chemistry-lesson-planning"]
...
帮助化学老师把“这节课讲什么”升级为目标、活动、提问、练习和评价一致的课堂设计，重点围绕微观解释、实验现象、化学用语和反应规律。
...
- 帮我设计一节八年级化学新课，学生基础一般，要有关键提问和出口检测。
- 化学公开课初稿，帮我把活动和评价对齐。
...
意图：
- `teacher_chemistry_lesson_planning`
- `teacher_institution`
- `老师备课`
...
- Install Aliases: `teacher-chemistry-lesson-planning`
- Stages: `primary`, `junior`, `senior`
- Subjects: `化学`
- Abilities: `教学设计`
