---
name: "teacher-english-lesson-planning"
description: "帮助英语老师把“这节课讲什么”升级为目标、活动、提问、练习和评价一致的课堂设计，重点围绕词汇、语篇、听说读写和真实语境使用。 Workflow: teacher_english_lesson_planning.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "英语", "教学设计", "老师备课"]
    source: hermes-edu-skills
    workflow: "teacher_english_lesson_planning.run"
    category: "teacher-tools"
    category_aliases: ["教师与机构", "老师工具", "教师工具", "teacher-tools", "teaching"]
    legacy_slugs: []
    install_aliases: ["teacher-english-lesson-planning"]
...
帮助英语老师把“这节课讲什么”升级为目标、活动、提问、练习和评价一致的课堂设计，重点围绕词汇、语篇、听说读写和真实语境使用。
...
- 帮我设计一节八年级英语新课，学生基础一般，要有关键提问和出口检测。
- 英语公开课初稿，帮我把活动和评价对齐。
...
意图：
- `teacher_english_lesson_planning`
- `teacher_institution`
- `老师备课`
...
- Install Aliases: `teacher-english-lesson-planning`
- Stages: `primary`, `junior`, `senior`
- Subjects: `英语`
- Abilities: `教学设计`
