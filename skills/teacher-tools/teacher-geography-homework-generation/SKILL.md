---
name: "teacher-geography-homework-generation"
description: "帮助地理老师生成少而准、可批改、能反映真实掌握情况的分层作业，避免把作业变成题量堆叠。 Workflow: teacher_geography_homework_generation.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "地理", "作业生成", "班级作业"]
    source: hermes-edu-skills
    workflow: "teacher_geography_homework_generation.run"
    category: "teacher-tools"
    category_aliases: ["教师与机构", "老师工具", "教师工具", "teacher-tools", "teaching"]
    legacy_slugs: []
    install_aliases: ["teacher-geography-homework-generation"]
...
帮助地理老师生成少而准、可批改、能反映真实掌握情况的分层作业，避免把作业变成题量堆叠。
...
- 给七年级地理生成 20 分钟分层作业，要有答案和批改关注点。
- 地理这一课学生错得多，帮我做一份补偿练习。
...
意图：
- `teacher_geography_homework_generation`
- `teacher_institution`
- `班级作业`
...
- Install Aliases: `teacher-geography-homework-generation`
- Stages: `primary`, `junior`, `senior`
- Subjects: `地理`
- Abilities: `作业生成`
