---
name: "teacher-politics-lesson-planning"
description: "帮助政治老师把“这节课讲什么”升级为目标、活动、提问、练习和评价一致的课堂设计，重点围绕概念理解、材料分析、价值判断、现实情境和规范表达。 Workflow: teacher_politics_lesson_planning.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "teacher_politics_lesson_planning.run"
    category: "teacher-tools"
    category_aliases: ["教师与机构", "老师工具", "教师工具", "teacher-tools", "teaching"]
    legacy_slugs: []
    install_aliases: ["teacher-politics-lesson-planning"]
...
帮助政治老师把“这节课讲什么”升级为目标、活动、提问、练习和评价一致的课堂设计，重点围绕概念理解、材料分析、价值判断、现实情境和规范表达。
...
- 帮我设计一节八年级政治新课，学生基础一般，要有关键提问和出口检测。
- 政治公开课初稿，帮我把活动和评价对齐。
...
意图：
- `teacher_politics_lesson_planning`
- `teacher_institution`
- `老师备课`
...
- Install Aliases: `teacher-politics-lesson-planning`
- Stages: `primary`, `junior`, `senior`
- Subjects: `政治`
- Abilities: `教学设计`
