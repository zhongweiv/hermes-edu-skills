---
name: "teacher-geography-lesson-planning"
description: "帮助地理老师把“这节课讲什么”升级为目标、活动、提问、练习和评价一致的课堂设计，重点围绕区域认知、地图判读、综合思维、地理实践力和人地协调观。 Workflow: teacher_geography_lesson_planning.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "地理", "教学设计", "老师备课"]
    source: hermes-edu-skills
    workflow: "teacher_geography_lesson_planning.run"
    category: "teacher-tools"
    category_aliases: ["教师与机构", "老师工具", "教师工具", "teacher-tools", "teaching"]
    legacy_slugs: []
    install_aliases: ["teacher-geography-lesson-planning"]
...
帮助地理老师把“这节课讲什么”升级为目标、活动、提问、练习和评价一致的课堂设计，重点围绕区域认知、地图判读、综合思维、地理实践力和人地协调观。
...
- 把课程目标改写成学生可观察的学习表现。
- 从地图、区域材料或真实地理现象提出问题，让学生用证据解释成因和影响
...
- 帮我设计一节八年级地理新课，学生基础一般，要有关键提问和出口检测。
- 地理公开课初稿，帮我把活动和评价对齐。
...
意图：
- `teacher_geography_lesson_planning`
- `teacher_institution`
- `老师备课`
...
- Install Aliases: `teacher-geography-lesson-planning`
- Stages: `primary`, `junior`, `senior`
- Subjects: `地理`
- Abilities: `教学设计`
