...
description: "语文单元复习 Skill是面向单元复习的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: teacher_chinese_unit_review.run."
version: "0.5.0"
author: zhongwei
license: MIT
...
语文单元复习 Skill是面向单元复习的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
