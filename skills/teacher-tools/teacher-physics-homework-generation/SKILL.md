...
description: "帮助物理老师生成少而准、可批改、能反映真实掌握情况的分层作业，避免把作业变成题量堆叠。 Workflow: teacher_physics_homework_generation.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    legacy_slugs: []
    install_aliases: ["teacher-physics-homework-generation"]
...
帮助物理老师生成少而准、可批改、能反映真实掌握情况的分层作业，避免把作业变成题量堆叠。
...
- 给七年级物理生成 20 分钟分层作业，要有答案和批改关注点。
- 物理这一课学生错得多，帮我做一份补偿练习。
...
- Install Aliases: `teacher-physics-homework-generation`
- Stages: `primary`, `junior`, `senior`
- Subjects: `物理`
- Abilities: `作业生成`
