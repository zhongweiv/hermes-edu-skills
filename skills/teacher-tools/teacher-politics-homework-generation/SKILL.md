...
description: "帮助政治老师生成少而准、可批改、能反映真实掌握情况的分层作业，避免把作业变成题量堆叠。 Workflow: teacher_politics_homework_generation.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    legacy_slugs: []
    install_aliases: ["teacher-politics-homework-generation"]
...
帮助政治老师生成少而准、可批改、能反映真实掌握情况的分层作业，避免把作业变成题量堆叠。
...
- 给七年级政治生成 20 分钟分层作业，要有答案和批改关注点。
- 政治这一课学生错得多，帮我做一份补偿练习。
...
意图：
- `teacher_politics_homework_generation`
- `teacher_institution`
- `班级作业`
...
- Install Aliases: `teacher-politics-homework-generation`
- Stages: `primary`, `junior`, `senior`
- Subjects: `政治`
- Abilities: `作业生成`
