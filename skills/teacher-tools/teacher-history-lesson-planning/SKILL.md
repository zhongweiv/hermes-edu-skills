...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "历史", "教学设计", "老师备课"]
    source: hermes-edu-skills
    workflow: "teacher_history_lesson_planning.run"
    category: "teacher-tools"
    category_aliases: ["教师与机构", "老师工具", "教师工具", "teacher-tools", "teaching"]
    legacy_slugs: []
    install_aliases: ["teacher-history-lesson-planning"]
...
意图：
- `teacher_history_lesson_planning`
- `teacher_institution`
- `老师备课`
...
- Install Aliases: `teacher-history-lesson-planning`
- Stages: `primary`, `junior`, `senior`
- Subjects: `历史`
- Abilities: `教学设计`
