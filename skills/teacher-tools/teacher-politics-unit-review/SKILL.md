...
description: "帮助政治老师把一个单元复习成知识结构、典型错因、主动回忆和再练习的闭环，而不是重新讲一遍。 Workflow: teacher_politics_unit_review.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    legacy_slugs: []
    install_aliases: ["teacher-politics-unit-review"]
...
帮助政治老师把一个单元复习成知识结构、典型错因、主动回忆和再练习的闭环，而不是重新讲一遍。
...
- 帮我做政治第二单元复习课，先用主动回忆，再按错因安排讲评。
- 这次政治单元测错题集中在这些点，帮我设计一节复习课。
...
- Install Aliases: `teacher-politics-unit-review`
- Stages: `primary`, `junior`, `senior`
- Subjects: `政治`
- Abilities: `复习计划`
