...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "物理", "教学设计", "老师备课"]
    source: hermes-edu-skills
    workflow: "teacher_physics_lesson_planning.run"
    category: "teacher-tools"
    category_aliases: ["教师与机构", "老师工具", "教师工具", "teacher-tools", "teaching"]
    legacy_slugs: []
    install_aliases: ["teacher-physics-lesson-planning"]
...
帮助物理老师把“这节课讲什么”升级为目标、活动、提问、练习和评价一致的课堂设计，重点围绕概念模型、实验探究、图像分析和受力/电路等推理过程。
...
- 帮我设计一节八年级物理新课，学生基础一般，要有关键提问和出口检测。
- 物理公开课初稿，帮我把活动和评价对齐。
...
意图：
- `teacher_physics_lesson_planning`
- `teacher_institution`
- `老师备课`
...
- Install Aliases: `teacher-physics-lesson-planning`
- Stages: `primary`, `junior`, `senior`
- Subjects: `物理`
- Abilities: `教学设计`
