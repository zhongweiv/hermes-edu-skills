...
description: "物理备课 Skill是面向老师备课的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: teacher_physics_lesson_planning.run."
version: "0.2.0"
author: zhongwei
license: MIT
...
物理备课 Skill是面向老师备课的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
