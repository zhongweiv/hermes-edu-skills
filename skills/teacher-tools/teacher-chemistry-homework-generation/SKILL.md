...
description: "化学作业生成 Skill是面向班级作业的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: teacher_chemistry_homework_generation.run."
version: "0.2.0"
author: zhongwei
license: MIT
...
化学作业生成 Skill是面向班级作业的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
