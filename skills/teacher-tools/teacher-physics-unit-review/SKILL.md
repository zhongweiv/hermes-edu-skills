---
name: "teacher-physics-unit-review"
description: "帮助物理老师把一个单元复习成知识结构、典型错因、主动回忆和再练习的闭环，而不是重新讲一遍。 Workflow: teacher_physics_unit_review.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "物理", "复习计划", "单元复习"]
    source: hermes-edu-skills
    workflow: "teacher_physics_unit_review.run"
    category: "teacher-tools"
    category_aliases: ["教师与机构", "老师工具", "教师工具", "teacher-tools", "teaching"]
    legacy_slugs: []
    install_aliases: ["teacher-physics-unit-review"]
...
帮助物理老师把一个单元复习成知识结构、典型错因、主动回忆和再练习的闭环，而不是重新讲一遍。
...
- 帮我做物理第二单元复习课，先用主动回忆，再按错因安排讲评。
- 这次物理单元测错题集中在这些点，帮我设计一节复习课。
...
- Install Aliases: `teacher-physics-unit-review`
- Stages: `primary`, `junior`, `senior`
- Subjects: `物理`
- Abilities: `复习计划`
