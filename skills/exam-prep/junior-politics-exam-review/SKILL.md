---
name: "junior-politics-exam-review"
description: "把初中政治考试备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。 Workflow: junior_politics_exam_review.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
把初中政治考试备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。
...
- 初中政治考试，我现在是七年级，还有14 天，每天 45 分钟，帮我做提分计划。
- 初中政治考试复习，最近材料题知道概念但不会结合材料展开，请先诊断再安排 7 天专项训练。
- 下面是我最近 5 道错题，请按初中政治考试要求做错因分类、同类追练和复测安排。
