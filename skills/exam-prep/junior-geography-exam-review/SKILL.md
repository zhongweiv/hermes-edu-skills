---
name: "junior-geography-exam-review"
description: "把初中地理考试备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。 Workflow: junior_geography_exam_review.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "junior_geography_exam_review.run"
    category: "exam-prep"
    category_aliases: ["考试备考", "备考复习", "exam", "exam-prep"]
    legacy_slugs: []
    install_aliases: ["junior-geography-exam-review"]
    stages: ["junior"]
    subjects: ["地理"]
    abilities: ["考试复习", "查漏补缺"]
    scenarios: ["中考复习", "考前冲刺"]
...
把初中地理考试备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。
...
- 初中地理考试，我现在是七年级，还有14 天，每天 45 分钟，帮我做提分计划。
- 初中地理考试复习，最近地图题容易定位错，综合题成因总写不完整，请先诊断再安排 7 天专项训练。
- 下面是我最近 5 道错题，请按初中地理考试要求做错因分类、同类追练和复测安排。
...
- Install Aliases: `junior-geography-exam-review`
- Stages: `junior`
- Subjects: `地理`
- Abilities: `考试复习`, `查漏补缺`
