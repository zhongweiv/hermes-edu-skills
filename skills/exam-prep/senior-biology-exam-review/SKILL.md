...
metadata:
  hermes:
    tags: ["education", "senior", "生物", "考试复习", "查漏补缺", "高考复习", "考前冲刺"]
    source: hermes-edu-skills
    workflow: "senior_biology_exam_review.run"
    category: "exam-prep"
    category_aliases: ["考试备考", "备考复习", "exam", "exam-prep"]
    legacy_slugs: []
    install_aliases: ["senior-biology-exam-review"]
    stages: ["senior"]
    subjects: ["生物"]
    abilities: ["考试复习", "查漏补缺"]
    scenarios: ["高考复习", "考前冲刺"]
...
把高中生物考试备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。
...
- 高中生物考试，我现在是高一，还有14 天，每天 45 分钟，帮我做提分计划。
- 高中生物考试复习，最近图表题信息提取不完整，实验变量判断不稳，请先诊断再安排 7 天专项训练。
- 下面是我最近 5 道错题，请按高中生物考试要求做错因分类、同类追练和复测安排。
...
- Install Aliases: `senior-biology-exam-review`
- Stages: `senior`
- Subjects: `生物`
- Abilities: `考试复习`, `查漏补缺`
