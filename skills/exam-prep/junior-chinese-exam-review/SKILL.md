...
metadata:
  hermes:
    tags: ["education", "junior", "语文", "考试复习", "查漏补缺", "中考复习", "考前冲刺"]
...
把初中语文考试备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。
...
- 初中语文考试，我现在是七年级，还有14 天，每天 45 分钟，帮我做提分计划。
- 初中语文考试复习，最近阅读题总写不到采分点，作文立意也不够稳，请先诊断再安排 7 天专项训练。
- 下面是我最近 5 道错题，请按初中语文考试要求做错因分类、同类追练和复测安排。
