...
description: "初中语文考试复习 Skill是面向中考复习、考前冲刺的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: junior_chinese_exam_review.run."
version: "0.2.0"
author: zhongwei
license: MIT
...
初中语文考试复习 Skill是面向中考复习、考前冲刺的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
