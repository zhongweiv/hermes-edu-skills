...
description: "教师资格证备考 Skill是面向考证的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: teacher_certification_sprint.run."
version: "0.6.0"
author: zhongwei
license: MIT
...
教师资格证备考 Skill是面向考证的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
