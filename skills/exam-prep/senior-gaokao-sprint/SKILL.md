...
description: "高考冲刺 Skill是面向高考复习、考前冲刺的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: senior_gaokao_sprint.run."
version: "0.7.0"
author: zhongwei
license: MIT
...
高考冲刺 Skill是面向高考复习、考前冲刺的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
