...
把高考备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。
...
- 高考，我现在是高三，还有30 天，每天 45 分钟，帮我做提分计划。
- 高考复习，最近时间不多，很多知识点都觉得不稳，不知道先抓哪里，请先诊断再安排 7 天专项训练。
- 下面是我最近 5 道错题，请按高考要求做错因分类、同类追练和复测安排。
...
默认假设：
- 年级/水平未指定：默认使用 高三 范围；若任务需要精准教材进度，再提醒用户可补充年级。
