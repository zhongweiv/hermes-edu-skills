---
name: "college-cet6-sprint"
description: "把大学英语六级备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。 Workflow: college_cet6_sprint.run."
version: "0.10.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "college_cet6_sprint.run"
    category: "exam-prep"
    stages: ["college"]
    subjects: ["英语"]
...
把大学英语六级备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。
...
- 大学英语六级，我现在是大学，还有30 天，每天 45 分钟，帮我做提分计划。
- 大学英语六级复习，最近阅读长难句看不懂，写作句子也比较单一，请先诊断再安排 7 天专项训练。
- 下面是我最近 5 道错题，请按大学英语六级要求做错因分类、同类追练和复测安排。
