---
name: "senior-politics-exam-review"
description: "把高中政治考试备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。 Workflow: senior_politics_exam_review.run."
version: "0.13.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "政治", "考试复习", "查漏补缺", "高考复习", "考前冲刺"]
...
把高中政治考试备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。
...
- 先看概念混淆、材料关键词遗漏、观点不贴题和表达层次问题，给出 1-3 个最优先提分点。
- 按核心概念、材料关键词、现实情境、观点组织和规范表达设计复习路径，区分保分项、突破项和放弃/降权项。
- 按概念辨析、材料提取、观点组织和规范短答训练，每个任务都标注时长、题量、难度和完成标准。
- 把错题按概念、材料、观点、结构和现实联系分类，把每次训练转成错因卡片、同类追练和下次复测时间。
...
- 高中政治考试，我现在是高一，还有14 天，每天 45 分钟，帮我做提分计划。
- 高中政治考试复习，最近材料题知道概念但不会结合材料展开，请先诊断再安排 7 天专项训练。
- 下面是我最近 5 道错题，请按高中政治考试要求做错因分类、同类追练和复测安排。
