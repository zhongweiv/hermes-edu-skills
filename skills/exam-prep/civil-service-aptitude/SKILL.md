...
把公务员行测备考从“泛泛刷题”变成诊断、提分优先级、限时训练、错题复盘和下次复测的闭环，帮助用户知道现在最该抓什么、每天怎么练、怎么判断有没有进步。
...
- 公务员行测，我现在是成人学习，还有14 天，每天 45 分钟，帮我做提分计划。
- 公务员行测复习，最近正确率忽高忽低，材料题总抓不住重点，请先诊断再安排 7 天专项训练。
- 下面是我最近 5 道错题，请按公务员行测要求做错因分类、同类追练和复测安排。
