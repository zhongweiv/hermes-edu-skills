...
description: "公务员行测 Skill是面向考证、专项训练的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: civil_service_aptitude.run."
version: "0.2.0"
author: zhongwei
license: MIT
...
公务员行测 Skill是面向考证、专项训练的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
