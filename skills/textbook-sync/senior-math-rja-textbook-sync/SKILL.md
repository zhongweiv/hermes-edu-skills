---
name: "senior-math-rja-textbook-sync"
description: "把人教A版高中数学的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把教材单元变成今天能做、明天能复盘、错了能追练的学习闭环。 Workflow: senior_math_rja_textbook_sync.run."
version: "0.14.0"
author: zhongwei
license: MIT
...
把人教A版高中数学的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把教材单元变成今天能做、明天能复盘、错了能追练的学习闭环。
...
- 人教A版高中数学，高一必修一专题一，帮我做 15 分钟课前预习。
- 人教A版高中数学同步，高一必修一专题一，孩子最近数量关系容易看错，计算步骤也常漏，生成一组错题追练。
- 按人教A版高中数学做单元复习，年级是高一，册别是必修一，请给我知识点、易错点和原创练习。
