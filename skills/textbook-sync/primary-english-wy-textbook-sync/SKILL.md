---
name: "primary-english-wy-textbook-sync"
description: "把外研版小学英语的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。让英语同步学习从背单词变成会听、会读、会说、会写的短任务。 Workflow: primary_english_wy_textbook_sync.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "primary_english_wy_textbook_sync.run"
    category: "textbook-sync"
    category_aliases: ["教材同步", "同步教材", "textbook", "textbook-sync"]
    legacy_slugs: []
    install_aliases: ["primary-english-wy-textbook-sync"]
    stages: ["primary"]
    subjects: ["英语"]
...
把外研版小学英语的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。让英语同步学习从背单词变成会听、会读、会说、会写的短任务。
...
- 外研版小学英语，一年级上册第一单元，帮我做 15 分钟课前预习。
- 外研版小学英语同步，一年级上册第一单元，孩子最近单词会读不会写，阅读题定位也容易错，生成一组错题追练。
- 按外研版小学英语做单元复习，年级是一年级，册别是上册，请给我知识点、易错点和原创练习。
...
意图：
- `primary_english_wy_textbook_sync`
- `textbook_sync`
- `课前预习`
- `课后作业`
- `同步巩固`
...
- Install Aliases: `primary-english-wy-textbook-sync`
- Stages: `primary`
- Subjects: `英语`
- Abilities: `教材同步`, `词汇`, `听说读写`
