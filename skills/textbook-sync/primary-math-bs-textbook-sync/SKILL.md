...
把北师大版小学数学的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把教材单元变成今天能做、明天能复盘、错了能追练的学习闭环。
...
- 北师大版小学数学，一年级上册第一单元，帮我做 15 分钟课前预习。
- 北师大版小学数学同步，一年级上册第一单元，孩子最近数量关系容易看错，计算步骤也常漏，生成一组错题追练。
- 按北师大版小学数学做单元复习，年级是一年级，册别是上册，请给我知识点、易错点和原创练习。
