---
name: "senior-physics-lk-textbook-sync"
description: "把鲁科版高中物理的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把物理教材同步变成现象-模型-证据-应用的清晰学习路径。 Workflow: senior_physics_lk_textbook_sync.run."
version: "0.14.0"
author: zhongwei
license: MIT
...
把鲁科版高中物理的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把物理教材同步变成现象-模型-证据-应用的清晰学习路径。
...
- 鲁科版高中物理，高一必修一专题一，帮我做 15 分钟课前预习。
- 鲁科版高中物理同步，高一必修一专题一，孩子最近公式会背但不会判断模型条件，图像题容易读错，生成一组错题追练。
- 按鲁科版高中物理做单元复习，年级是高一，册别是必修一，请给我知识点、易错点和原创练习。
...
意图：
- `senior_physics_lk_textbook_sync`
- `textbook_sync`
- `课前预习`
- `课后作业`
- `同步巩固`
