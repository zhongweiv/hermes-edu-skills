---
name: "senior-english-rj-textbook-sync"
description: "把人教版高中英语的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。让英语同步学习从背单词变成会听、会读、会说、会写的短任务。 Workflow: senior_english_rj_textbook_sync.run."
version: "0.14.0"
author: zhongwei
license: MIT
...
把人教版高中英语的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。让英语同步学习从背单词变成会听、会读、会说、会写的短任务。
...
- 人教版高中英语，高一必修一专题一，帮我做 15 分钟课前预习。
- 人教版高中英语同步，高一必修一专题一，孩子最近单词会读不会写，阅读题定位也容易错，生成一组错题追练。
- 按人教版高中英语做单元复习，年级是高一，册别是必修一，请给我知识点、易错点和原创练习。
...
意图：
- `senior_english_rj_textbook_sync`
- `textbook_sync`
- `课前预习`
- `课后作业`
- `同步巩固`
