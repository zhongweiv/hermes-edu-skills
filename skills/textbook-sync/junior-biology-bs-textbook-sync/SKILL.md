---
name: "junior-biology-bs-textbook-sync"
description: "把北师大版初中生物的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把生物教材同步做成能看图、会解释、能用证据表达的学习过程。 Workflow: junior_biology_bs_textbook_sync.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "junior_biology_bs_textbook_sync.run"
    category: "textbook-sync"
    category_aliases: ["教材同步", "同步教材", "textbook", "textbook-sync"]
    legacy_slugs: []
    install_aliases: ["junior-biology-bs-textbook-sync"]
    stages: ["junior"]
    subjects: ["生物"]
    abilities: ["教材同步", "知识记忆"]
...
把北师大版初中生物的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把生物教材同步做成能看图、会解释、能用证据表达的学习过程。
...
- 北师大版初中生物，七年级上册第一单元，帮我做 15 分钟课前预习。
- 北师大版初中生物同步，七年级上册第一单元，孩子最近结构和功能关系说不清，图表信息提取不完整，生成一组错题追练。
- 按北师大版初中生物做单元复习，年级是七年级，册别是上册，请给我知识点、易错点和原创练习。
...
意图：
- `junior_biology_bs_textbook_sync`
- `textbook_sync`
- `课前预习`
- `课后作业`
- `同步巩固`
...
- Install Aliases: `junior-biology-bs-textbook-sync`
- Stages: `junior`
- Subjects: `生物`
- Abilities: `教材同步`, `知识记忆`
