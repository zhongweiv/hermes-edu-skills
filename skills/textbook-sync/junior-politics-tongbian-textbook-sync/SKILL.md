---
name: "junior-politics-tongbian-textbook-sync"
description: "把统编版初中政治的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。让道法/政治同步学习从背模板变成会读材料、会表达观点。 Workflow: junior_politics_tongbian_textbook_sync.run."
version: "0.14.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "junior", "政治", "教材同步", "材料分析", "课前预习", "课后作业", "同步巩固", "单元复习", "错题巩固", "期中期末复习", "中考复习"]
...
把统编版初中政治的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。让道法/政治同步学习从背模板变成会读材料、会表达观点。
...
- 统编版初中政治，七年级上册第一单元，帮我做 15 分钟课前预习。
- 统编版初中政治同步，七年级上册第一单元，孩子最近知道概念但不会结合材料展开，答案像背模板，生成一组错题追练。
- 按统编版初中政治做单元复习，年级是七年级，册别是上册，请给我知识点、易错点和原创练习。
...
意图：
- `junior_politics_tongbian_textbook_sync`
- `textbook_sync`
- `课前预习`
- `课后作业`
- `同步巩固`
