---
name: "junior-math-sj-textbook-sync"
description: "把苏教版初中数学的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把教材单元变成今天能做、明天能复盘、错了能追练的学习闭环。 Workflow: junior_math_sj_textbook_sync.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "junior_math_sj_textbook_sync.run"
    category: "textbook-sync"
    category_aliases: ["教材同步", "同步教材", "textbook", "textbook-sync"]
    legacy_slugs: []
    install_aliases: ["junior-math-sj-textbook-sync"]
    stages: ["junior"]
    subjects: ["数学"]
...
把苏教版初中数学的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把教材单元变成今天能做、明天能复盘、错了能追练的学习闭环。
...
- 苏教版初中数学，七年级上册第一单元，帮我做 15 分钟课前预习。
- 苏教版初中数学同步，七年级上册第一单元，孩子最近数量关系容易看错，计算步骤也常漏，生成一组错题追练。
- 按苏教版初中数学做单元复习，年级是七年级，册别是上册，请给我知识点、易错点和原创练习。
...
- Install Aliases: `junior-math-sj-textbook-sync`
- Stages: `junior`
- Subjects: `数学`
- Abilities: `教材同步`, `函数`, `几何`
