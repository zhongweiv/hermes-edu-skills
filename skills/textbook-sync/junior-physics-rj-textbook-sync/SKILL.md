...
把人教版初中物理的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把物理教材同步变成现象-模型-证据-应用的清晰学习路径。
...
- 人教版初中物理，七年级上册第一单元，帮我做 15 分钟课前预习。
- 人教版初中物理同步，七年级上册第一单元，孩子最近公式会背但不会判断模型条件，图像题容易读错，生成一组错题追练。
- 按人教版初中物理做单元复习，年级是七年级，册别是上册，请给我知识点、易错点和原创练习。
