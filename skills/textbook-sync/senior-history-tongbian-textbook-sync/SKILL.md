---
name: "senior-history-tongbian-textbook-sync"
description: "把统编版高中历史的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。让历史同步学习从背年代结论变成会用材料说明因果和观点。 Workflow: senior_history_tongbian_textbook_sync.run."
version: "0.14.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "历史", "教材同步", "材料分析", "课前预习", "课后作业", "同步巩固", "单元复习", "错题巩固", "期中期末复习", "高考复习"]
...
把统编版高中历史的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。让历史同步学习从背年代结论变成会用材料说明因果和观点。
...
- 统编版高中历史，高一必修一专题一，帮我做 15 分钟课前预习。
- 统编版高中历史同步，高一必修一专题一，孩子最近材料题抓不到关键词，历史事件影响写得很散，生成一组错题追练。
- 按统编版高中历史做单元复习，年级是高一，册别是必修一，请给我知识点、易错点和原创练习。
...
意图：
- `senior_history_tongbian_textbook_sync`
- `textbook_sync`
- `课前预习`
- `课后作业`
- `同步巩固`
