...
description: "把人教版高中生物的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把生物教材同步做成能看图、会解释、能用证据表达的学习过程。 Workflow: senior_biology_rj_textbook_sync.run."
version: "0.14.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "senior_biology_rj_textbook_sync.run"
    category: "textbook-sync"
    category_aliases: ["教材同步", "同步教材", "textbook", "textbook-sync"]
    legacy_slugs: []
    install_aliases: ["senior-biology-rj-textbook-sync"]
    stages: ["senior"]
    subjects: ["生物"]
    abilities: ["教材同步", "知识记忆"]
...
把人教版高中生物的年级、册别、单元和学习场景，转成预习、同步练习、错题追练、单元复习和考前巩固等可直接执行的学习任务。把生物教材同步做成能看图、会解释、能用证据表达的学习过程。
...
- 人教版高中生物，高一必修一专题一，帮我做 15 分钟课前预习。
- 人教版高中生物同步，高一必修一专题一，孩子最近结构和功能关系说不清，图表信息提取不完整，生成一组错题追练。
- 按人教版高中生物做单元复习，年级是高一，册别是必修一，请给我知识点、易错点和原创练习。
...
意图：
- `senior_biology_rj_textbook_sync`
- `textbook_sync`
- `课前预习`
- `课后作业`
- `同步巩固`
...
- Install Aliases: `senior-biology-rj-textbook-sync`
- Stages: `senior`
- Subjects: `生物`
- Abilities: `教材同步`, `知识记忆`
