---
name: "primary-math-unit-conversion"
description: "单位换算 Skill用于课后作业、专项训练，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: primary_math_unit_conversion.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "primary_math_unit_conversion.run"
    category: "math"
    stages: ["primary"]
    subjects: ["数学"]
    abilities: ["计算"]
...
单位换算 Skill用于课后作业、专项训练，由 Hermes Agent Runtime 按独立 Agent Context 调用。
