...
description: "线性代数 Skill用于同步巩固、考试复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: college_math_linear_algebra.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "college", "数学", "计算", "逻辑", "同步巩固", "考试复习"]
    source: hermes-edu-skills
    workflow: "college_math_linear_algebra.run"
    category: "math"
    stages: ["college"]
    subjects: ["数学"]
    abilities: ["计算", "逻辑"]
...
线性代数 Skill用于同步巩固、考试复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。
