...
description: "高等数学 Skill用于同步巩固、考试复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: college_math_calculus.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "college_math_calculus.run"
    category: "math"
    stages: ["college"]
    subjects: ["数学"]
    abilities: ["计算", "逻辑"]
...
高等数学 Skill用于同步巩固、考试复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。
