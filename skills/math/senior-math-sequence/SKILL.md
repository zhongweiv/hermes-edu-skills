---
name: "senior-math-sequence"
description: "数列 Skill用于专项训练、高考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: senior_math_sequence.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "senior_math_sequence.run"
    category: "math"
    stages: ["senior"]
    subjects: ["数学"]
    abilities: ["逻辑", "计算"]
...
数列 Skill用于专项训练、高考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。
