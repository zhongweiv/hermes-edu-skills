...
description: "续费风险分析 Skill是面向续费报告的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: institution_renewal_insight.run."
version: "0.5.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "adult", "机构运营", "运营分析", "续费报告"]
...
续费风险分析 Skill是面向续费报告的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
