...
description: "老师效率分析 Skill是面向数据分析的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: institution_teacher_efficiency.run."
version: "0.7.0"
author: zhongwei
license: MIT
...
老师效率分析 Skill是面向数据分析的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
