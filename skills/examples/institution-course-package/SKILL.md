...
description: "机构课程包 Skill是面向机构课程的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: institution_course_package.run."
version: "0.6.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "primary", "junior", "senior", "adult", "机构运营", "运营分析", "机构课程"]
...
机构课程包 Skill是面向机构课程的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
