...
description: "学前拼音启蒙 Skill把拼音启蒙做成孩子愿意参与、家长能照着做、过程可观察的入学准备任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_pinyin_foundation.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    legacy_slugs: []
    install_aliases: ["preschool-pinyin-foundation"]
    stages: ["preschool"]
    subjects: ["语文"]
    abilities: ["拼音启蒙"]
    scenarios: ["入学准备", "每日启蒙"]
...
学前拼音启蒙 Skill把拼音启蒙做成孩子愿意参与、家长能照着做、过程可观察的入学准备任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做拼音启蒙，今晚只有 10 分钟，帮我设计一个亲子小游戏。
...
- Install Aliases: `preschool-pinyin-foundation`
- Stages: `preschool`
- Subjects: `语文`
- Abilities: `拼音启蒙`
