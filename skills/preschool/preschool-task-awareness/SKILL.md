---
name: "preschool-task-awareness"
description: "学前任务意识 Skill把任务意识做成孩子愿意参与、家长能照着做、过程可观察的习惯培养任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_task_awareness.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "学习能力", "任务意识", "习惯培养", "入学准备"]
    source: hermes-edu-skills
    workflow: "preschool_task_awareness.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-task-awareness"]
    stages: ["preschool"]
    subjects: ["学习能力"]
    abilities: ["任务意识"]
    scenarios: ["习惯培养", "入学准备"]
...
学前任务意识 Skill把任务意识做成孩子愿意参与、家长能照着做、过程可观察的习惯培养任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做任务意识，今晚只有 10 分钟，帮我设计一个亲子小游戏。
...
- Install Aliases: `preschool-task-awareness`
- Stages: `preschool`
- Subjects: `学习能力`
- Abilities: `任务意识`
