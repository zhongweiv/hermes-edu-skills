---
name: "preschool-life-habits"
description: "学前生活习惯 Skill把生活习惯做成孩子愿意参与、家长能照着做、过程可观察的家庭陪伴任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_life_habits.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "家庭教育", "生活习惯", "家庭陪伴", "习惯培养"]
    source: hermes-edu-skills
    workflow: "preschool_life_habits.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-life-habits"]
    stages: ["preschool"]
    subjects: ["家庭教育"]
    abilities: ["生活习惯"]
    scenarios: ["家庭陪伴", "习惯培养"]
...
学前生活习惯 Skill把生活习惯做成孩子愿意参与、家长能照着做、过程可观察的家庭陪伴任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做生活习惯，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对生活习惯有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-life-habits`
- Stages: `preschool`
- Subjects: `家庭教育`
- Abilities: `生活习惯`
