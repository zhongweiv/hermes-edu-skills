---
name: "preschool-family-readiness"
description: "幼小衔接家庭准备 Skill把陪学建议做成孩子愿意参与、家长能照着做、过程可观察的入学准备任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_family_readiness.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "preschool_family_readiness.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: ["family-school-readiness"]
    install_aliases: ["preschool-family-readiness", "family-school-readiness"]
    stages: ["preschool"]
    subjects: ["家庭教育"]
    abilities: ["陪学建议", "入学准备"]
    scenarios: ["入学准备", "家长陪学"]
...
幼小衔接家庭准备 Skill把陪学建议做成孩子愿意参与、家长能照着做、过程可观察的入学准备任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做陪学建议，今晚只有 10 分钟，帮我设计一个亲子小游戏。
...
- Workflow: `preschool_family_readiness.run`
- Category: `preschool`
- Legacy Slugs: `family-school-readiness`
- Install Aliases: `preschool-family-readiness`, `family-school-readiness`
- Stages: `preschool`
- Subjects: `家庭教育`
- Abilities: `陪学建议`, `入学准备`
