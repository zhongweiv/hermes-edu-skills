---
name: "preschool-literacy-foundation"
description: "学前识字启蒙 Skill把识字启蒙做成孩子愿意参与、家长能照着做、过程可观察的每日启蒙任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_literacy_foundation.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "语文", "识字启蒙", "每日启蒙", "亲子共学"]
    source: hermes-edu-skills
    workflow: "preschool_literacy_foundation.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: ["preschool-literacy-daily"]
    install_aliases: ["preschool-literacy-foundation", "preschool-literacy-daily"]
    stages: ["preschool"]
    subjects: ["语文"]
    abilities: ["识字启蒙"]
    scenarios: ["每日启蒙", "亲子共学"]
...
学前识字启蒙 Skill把识字启蒙做成孩子愿意参与、家长能照着做、过程可观察的每日启蒙任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做识字启蒙，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对识字启蒙有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- 开始学前识字启蒙 Skill
- 帮我做每日启蒙
- 根据当前上下文执行学前识字启蒙 Skill

## 公开 Skill 契约 / Public Skill Contract

- Workflow: `preschool_literacy_foundation.run`
- Category: `preschool`
- Legacy Slugs: `preschool-literacy-daily`
- Install Aliases: `preschool-literacy-foundation`, `preschool-literacy-daily`
- Stages: `preschool`
- Subjects: `语文`
- Abilities: `识字启蒙`
