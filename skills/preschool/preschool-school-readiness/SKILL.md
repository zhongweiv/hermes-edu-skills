...
description: "幼小衔接综合 Skill把入学准备做成孩子愿意参与、家长能照着做、过程可观察的入学准备任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_school_readiness.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "综合", "入学准备", "习惯培养", "入学准备", "暑假提升"]
    source: hermes-edu-skills
    workflow: "preschool_school_readiness.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: ["preschool-general-readiness-textbook-sync"]
    install_aliases: ["preschool-school-readiness", "preschool-general-readiness-textbook-sync"]
    stages: ["preschool"]
    subjects: ["综合"]
    abilities: ["入学准备", "习惯培养"]
    scenarios: ["入学准备", "暑假提升"]
...
幼小衔接综合 Skill把入学准备做成孩子愿意参与、家长能照着做、过程可观察的入学准备任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做入学准备，今晚只有 10 分钟，帮我设计一个亲子小游戏。
...
- Workflow: `preschool_school_readiness.run`
- Category: `preschool`
- Legacy Slugs: `preschool-general-readiness-textbook-sync`
- Install Aliases: `preschool-school-readiness`, `preschool-general-readiness-textbook-sync`
- Stages: `preschool`
- Subjects: `综合`
- Abilities: `入学准备`, `习惯培养`
