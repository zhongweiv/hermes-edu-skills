---
name: "preschool-story-retelling"
description: "学前故事复述 Skill把故事复述做成孩子愿意参与、家长能照着做、过程可观察的绘本复述任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_story_retelling.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "preschool_story_retelling.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-story-retelling"]
    stages: ["preschool"]
    subjects: ["语文"]
    abilities: ["故事复述"]
    scenarios: ["绘本复述", "睡前表达"]
...
学前故事复述 Skill把故事复述做成孩子愿意参与、家长能照着做、过程可观察的绘本复述任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做故事复述，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对故事复述有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-story-retelling`
- Stages: `preschool`
- Subjects: `语文`
- Abilities: `故事复述`
