---
name: "preschool-self-care"
description: "学前自理能力 Skill把自理能力做成孩子愿意参与、家长能照着做、过程可观察的家庭陪伴任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_self_care.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "preschool_self_care.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-self-care"]
    stages: ["preschool"]
    subjects: ["家庭教育"]
    abilities: ["自理能力"]
    scenarios: ["家庭陪伴", "入学准备"]
...
学前自理能力 Skill把自理能力做成孩子愿意参与、家长能照着做、过程可观察的家庭陪伴任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做自理能力，今晚只有 10 分钟，帮我设计一个亲子小游戏。
...
- Install Aliases: `preschool-self-care`
- Stages: `preschool`
- Subjects: `家庭教育`
- Abilities: `自理能力`
