...
description: "学前图形空间 Skill把图形空间做成孩子愿意参与、家长能照着做、过程可观察的图形游戏任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_shape_space.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    legacy_slugs: []
    install_aliases: ["preschool-shape-space"]
    stages: ["preschool"]
    subjects: ["数学"]
    abilities: ["图形空间"]
    scenarios: ["图形游戏", "亲子共学"]
...
学前图形空间 Skill把图形空间做成孩子愿意参与、家长能照着做、过程可观察的图形游戏任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做图形空间，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对图形空间有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-shape-space`
- Stages: `preschool`
- Subjects: `数学`
- Abilities: `图形空间`
