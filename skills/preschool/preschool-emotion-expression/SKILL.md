---
name: "preschool-emotion-expression"
description: "学前情绪表达 Skill把情绪表达做成孩子愿意参与、家长能照着做、过程可观察的亲子沟通任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_emotion_expression.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "家庭教育", "情绪表达", "亲子沟通", "情绪支持"]
    source: hermes-edu-skills
    workflow: "preschool_emotion_expression.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-emotion-expression"]
    stages: ["preschool"]
    subjects: ["家庭教育"]
    abilities: ["情绪表达"]
    scenarios: ["亲子沟通", "情绪支持"]
...
学前情绪表达 Skill把情绪表达做成孩子愿意参与、家长能照着做、过程可观察的亲子沟通任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做情绪表达，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对情绪表达有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-emotion-expression`
- Stages: `preschool`
- Subjects: `家庭教育`
- Abilities: `情绪表达`
