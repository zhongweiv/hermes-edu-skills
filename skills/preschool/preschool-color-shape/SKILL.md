---
name: "preschool-color-shape"
description: "学前颜色形状 Skill把颜色形状做成孩子愿意参与、家长能照着做、过程可观察的每日启蒙任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_color_shape.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "综合", "颜色形状", "每日启蒙", "亲子共学"]
    source: hermes-edu-skills
    workflow: "preschool_color_shape.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-color-shape"]
    stages: ["preschool"]
    subjects: ["综合"]
    abilities: ["颜色形状"]
    scenarios: ["每日启蒙", "亲子共学"]
...
学前颜色形状 Skill把颜色形状做成孩子愿意参与、家长能照着做、过程可观察的每日启蒙任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做颜色形状，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对颜色形状有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-color-shape`
- Stages: `preschool`
- Subjects: `综合`
- Abilities: `颜色形状`
