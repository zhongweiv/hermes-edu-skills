...
description: "学前逻辑规律 Skill把分类排序做成孩子愿意参与、家长能照着做、过程可观察的逻辑游戏任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_logic_thinking.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    legacy_slugs: []
    install_aliases: ["preschool-logic-thinking"]
    stages: ["preschool"]
    subjects: ["数学"]
    abilities: ["分类排序", "规律发现"]
    scenarios: ["逻辑游戏", "亲子共学"]
...
学前逻辑规律 Skill把分类排序做成孩子愿意参与、家长能照着做、过程可观察的逻辑游戏任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做分类排序，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对分类排序有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-logic-thinking`
- Stages: `preschool`
- Subjects: `数学`
- Abilities: `分类排序`, `规律发现`
