---
name: "preschool-parent-daily-play"
description: "亲子每日启蒙 Skill把亲子陪伴做成孩子愿意参与、家长能照着做、过程可观察的每日启蒙任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_parent_daily_play.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "家庭教育", "亲子陪伴", "每日启蒙", "每日启蒙", "亲子共学"]
    source: hermes-edu-skills
    workflow: "preschool_parent_daily_play.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-parent-daily-play"]
    stages: ["preschool"]
    subjects: ["家庭教育"]
    abilities: ["亲子陪伴", "每日启蒙"]
    scenarios: ["每日启蒙", "亲子共学"]
...
亲子每日启蒙 Skill把亲子陪伴做成孩子愿意参与、家长能照着做、过程可观察的每日启蒙任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做亲子陪伴，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对亲子陪伴有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-parent-daily-play`
- Stages: `preschool`
- Subjects: `家庭教育`
- Abilities: `亲子陪伴`, `每日启蒙`
