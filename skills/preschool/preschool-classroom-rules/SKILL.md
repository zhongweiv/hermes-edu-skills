---
name: "preschool-classroom-rules"
description: "学前课堂规则准备 Skill把规则感做成孩子愿意参与、家长能照着做、过程可观察的入学准备任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_classroom_rules.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "综合", "规则感", "课堂准备", "入学准备", "亲子演练"]
    source: hermes-edu-skills
    workflow: "preschool_classroom_rules.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-classroom-rules"]
    stages: ["preschool"]
    subjects: ["综合"]
    abilities: ["规则感", "课堂准备"]
    scenarios: ["入学准备", "亲子演练"]
...
学前课堂规则准备 Skill把规则感做成孩子愿意参与、家长能照着做、过程可观察的入学准备任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做规则感，今晚只有 10 分钟，帮我设计一个亲子小游戏。
...
- Install Aliases: `preschool-classroom-rules`
- Stages: `preschool`
- Subjects: `综合`
- Abilities: `规则感`, `课堂准备`
