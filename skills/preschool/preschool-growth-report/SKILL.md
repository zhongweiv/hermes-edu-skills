---
name: "preschool-growth-report"
description: "学前成长观察报告 Skill把成长观察做成孩子愿意参与、家长能照着做、过程可观察的成长报告任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_growth_report.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "家庭教育", "成长观察", "家庭反馈", "成长报告", "家园沟通"]
    source: hermes-edu-skills
    workflow: "preschool_growth_report.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-growth-report"]
    stages: ["preschool"]
    subjects: ["家庭教育"]
    abilities: ["成长观察", "家庭反馈"]
    scenarios: ["成长报告", "家园沟通"]
    ...
    requires_tools: ["context.load", "entitlement.check", "workflow.create", "activity.generate_play_task", "parent_guidance.generate", "report.aggregate_metrics", "organization.query_context", "memory.write"]
    requires_data: ["孩子年龄/阶段", "启蒙主题或入学准备目标", "可用时间", "家长是否陪伴", "可用材料", "孩子最近状态或兴趣点"]
---

# 学前成长观察报告 Skill

学前成长观察报告 Skill把成长观察做成孩子愿意参与、家长能照着做、过程可观察的成长报告任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做成长观察，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对成长观察有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-growth-report`
- Stages: `preschool`
- Subjects: `家庭教育`
- Abilities: `成长观察`, `家庭反馈`
...
- Requires Tools: `context.load`, `entitlement.check`, `workflow.create`, `activity.generate_play_task`, `parent_guidance.generate`, `report.aggregate_metrics`, `organization.query_context`, `memory.write`
