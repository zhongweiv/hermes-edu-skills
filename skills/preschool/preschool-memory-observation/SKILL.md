---
name: "preschool-memory-observation"
description: "学前观察记忆 Skill把观察力做成孩子愿意参与、家长能照着做、过程可观察的观察游戏任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_memory_observation.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "学习能力", "观察力", "记忆力", "观察游戏", "亲子共学"]
    source: hermes-edu-skills
    workflow: "preschool_memory_observation.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-memory-observation"]
    stages: ["preschool"]
    subjects: ["学习能力"]
    abilities: ["观察力", "记忆力"]
    scenarios: ["观察游戏", "亲子共学"]
...
学前观察记忆 Skill把观察力做成孩子愿意参与、家长能照着做、过程可观察的观察游戏任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做观察力，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对观察力有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-memory-observation`
- Stages: `preschool`
- Subjects: `学习能力`
- Abilities: `观察力`, `记忆力`
