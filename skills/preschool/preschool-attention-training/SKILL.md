---
name: "preschool-attention-training"
description: "学前专注力训练 Skill把专注力做成孩子愿意参与、家长能照着做、过程可观察的专注游戏任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_attention_training.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "学习能力", "专注力", "专注游戏", "每日打卡"]
    source: hermes-edu-skills
    workflow: "preschool_attention_training.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-attention-training"]
    stages: ["preschool"]
    subjects: ["学习能力"]
    abilities: ["专注力"]
    scenarios: ["专注游戏", "每日打卡"]
...
学前专注力训练 Skill把专注力做成孩子愿意参与、家长能照着做、过程可观察的专注游戏任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做专注力，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对专注力有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-attention-training`
- Stages: `preschool`
- Subjects: `学习能力`
- Abilities: `专注力`
