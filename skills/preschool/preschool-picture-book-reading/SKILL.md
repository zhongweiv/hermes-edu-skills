---
name: "preschool-picture-book-reading"
description: "学前绘本共读 Skill把绘本阅读做成孩子愿意参与、家长能照着做、过程可观察的亲子共读任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_picture_book_reading.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "preschool_picture_book_reading.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-picture-book-reading"]
    stages: ["preschool"]
    subjects: ["语文"]
    abilities: ["绘本阅读", "理解表达"]
    scenarios: ["亲子共读", "睡前阅读"]
...
学前绘本共读 Skill把绘本阅读做成孩子愿意参与、家长能照着做、过程可观察的亲子共读任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做绘本阅读，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对绘本阅读有点抗拒，帮我设计一个不刷题的启蒙活动。
...
意图：
- `preschool_picture_book_reading`
- `preschool`
- `亲子共读`
- `睡前阅读`
...
- Install Aliases: `preschool-picture-book-reading`
- Stages: `preschool`
- Subjects: `语文`
- Abilities: `绘本阅读`, `理解表达`
