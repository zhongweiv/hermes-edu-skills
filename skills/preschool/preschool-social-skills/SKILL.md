---
name: "preschool-social-skills"
description: "学前社交规则 Skill把同伴交往做成孩子愿意参与、家长能照着做、过程可观察的社交练习任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。 Workflow: preschool_social_skills.run."
version: "0.17.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "preschool_social_skills.run"
    category: "preschool"
    category_aliases: ["学前启蒙", "学龄前", "幼小衔接", "preschool"]
    legacy_slugs: []
    install_aliases: ["preschool-social-skills"]
    stages: ["preschool"]
    subjects: ["家庭教育"]
    abilities: ["同伴交往", "规则感"]
    scenarios: ["社交练习", "幼儿园适应"]
    quality_tier: "curated"
    standalone_support: "needs_user_input"
    public_release: "recommended"
    export_mode: "installable"
    release_channel: "recommended"
    requires_tools: ["context.load", "entitlement.check", "workflow.create", "practice.generate_items", "practice.grade_answers", "activity.generate_play_task", "parent_guidance.generate", "organization.query_context", "memory.write"]
    requires_data: ["孩子年龄/阶段", "启蒙主题或入学准备目标", "可用时间", "家长是否陪伴", "可用材料", "孩子最近状态或兴趣点"]
---

# 学前社交规则 Skill

学前社交规则 Skill把同伴交往做成孩子愿意参与、家长能照着做、过程可观察的社交练习任务。重点不是提前小学化，而是在真实生活、绘本、游戏和表达里建立安全感、兴趣和基础能力。
...
- 5 岁孩子想做同伴交往，今晚只有 10 分钟，帮我设计一个亲子小游戏。
- 孩子对同伴交往有点抗拒，帮我设计一个不刷题的启蒙活动。
...
- Install Aliases: `preschool-social-skills`
- Stages: `preschool`
- Subjects: `家庭教育`
- Abilities: `同伴交往`, `规则感`
...
- Requires Tools: `context.load`, `entitlement.check`, `workflow.create`, `practice.generate_items`, `practice.grade_answers`, `activity.generate_play_task`, `parent_guidance.generate`, `organization.query_context`, `memory.write`
