...
metadata:
  hermes:
    ...
    category_aliases: ["拍照答疑", "拍题讲解", "photo-question", "学习助手", "学习方法", "学习核心", "learning", "learning-core", "learning-assistant"]
    legacy_slugs: []
    install_aliases: ["agent-photo-question"]
...
- Install Aliases: `agent-photo-question`
- Stages: `primary`, `junior`, `senior`
- Subjects: `综合`
- Abilities: `AI 讲题`, `图片识题`
