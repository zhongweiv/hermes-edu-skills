...
metadata:
  hermes:
    ...
    legacy_slugs: []
    install_aliases: ["agent-question-explanation"]
...
- Install Aliases: `agent-question-explanation`
- Stages: `primary`, `junior`, `senior`, `college`
- Subjects: `学习能力`
- Abilities: `AI 讲题`, `举一反三`
...
默认假设：
- 年级/水平未指定：默认使用 一年级、二年级、三年级、四年级、五年级、六年级、七年级、八年级、九年级、高一、高二、高三、大学、考研 范围；若任务需要精准教材进度，再提醒用户可补充年级。
- 册别/学期未指定：默认覆盖 上册、下册、上册、下册、必修一、必修二、选择性必修、模块 范围；精准单元同步时优先请求用户补充目录或课题。
