---
name: "primary-math-mental-arithmetic-rj-grade2-volume1-daily"
description: "人教版二年级上册每日口算 Atomic Skill用于口算速练、每日打卡，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: primary_math_mental_arithmetic_rj_grade2_volume1_daily.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    ...
    workflow: "primary_math_mental_arithmetic_rj_grade2_volume1_daily.run"
    category: "atomic"
    stages: ["primary"]
    subjects: ["数学"]
    abilities: ["计算", "数感"]
...
# 人教版二年级上册每日口算 Atomic Skill

人教版二年级上册每日口算 Atomic Skill用于口算速练、每日打卡，由 Hermes Agent Runtime 按独立 Agent Context 调用。
...
意图：
- `primary_math_mental_arithmetic_rj_grade2_volume1_daily`
- `口算速练`
- `每日打卡`

示例表达：
- 开始人教版二年级上册每日口算 Atomic Skill
- 帮我安排口算速练
- 根据当前上下文执行人教版二年级上册每日口算 Atomic Skill
