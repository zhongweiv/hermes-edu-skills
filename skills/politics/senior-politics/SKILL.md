---
name: "senior-politics"
description: "高中政治 Skill用于同步巩固、高考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: senior_politics.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "政治", "知识记忆", "材料分析", "同步巩固", "高考复习"]
    source: hermes-edu-skills
    workflow: "senior_politics.run"
    category: "politics"
    stages: ["senior"]
    subjects: ["政治"]
    abilities: ["知识记忆", "材料分析"]
...
高中政治 Skill用于同步巩固、高考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。
