---
name: "institution-renewal-insight"
description: "续费风险分析 Skill用于续费报告，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: institution_renewal_insight.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "primary", "junior", "senior", "adult", "机构运营", "运营分析", "续费报告"]
    source: hermes-edu-skills
    workflow: "institution_renewal_insight.run"
...
续费风险分析 Skill用于续费报告，由 Hermes Agent Runtime 按独立 Agent Context 调用。
...
意图：
- `institution_renewal_insight`
- `续费报告`

示例表达：
- 开始续费风险分析 Skill
- 帮我安排续费报告
- 根据当前上下文执行续费风险分析 Skill
