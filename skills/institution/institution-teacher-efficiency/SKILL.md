---
name: "institution-teacher-efficiency"
description: "老师效率分析 Skill用于数据分析，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: institution_teacher_efficiency.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "primary", "junior", "senior", "adult", "机构运营", "运营分析", "数据分析"]
    source: hermes-edu-skills
    workflow: "institution_teacher_efficiency.run"
    category: "institution"
    stages: ["preschool", "primary", "junior", "senior", "adult"]
    subjects: ["机构运营"]
    abilities: ["运营分析"]
    scenarios: ["数据分析"]
...
老师效率分析 Skill用于数据分析，由 Hermes Agent Runtime 按独立 Agent Context 调用。
...
意图：
- `institution_teacher_efficiency`
- `数据分析`

示例表达：
- 开始老师效率分析 Skill
- 帮我安排数据分析
- 根据当前上下文执行老师效率分析 Skill
