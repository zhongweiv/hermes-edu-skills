...
description: "校区经营看板 Skill用于经营分析，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: institution_campus_dashboard.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "preschool", "primary", "junior", "senior", "adult", "机构运营", "运营分析", "经营分析"]
...
校区经营看板 Skill用于经营分析，由 Hermes Agent Runtime 按独立 Agent Context 调用。
