...
description: "家校沟通准备 Skill是面向家长沟通的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: family_school_communication.run."
version: "0.5.0"
author: zhongwei
license: MIT
...
家校沟通准备 Skill是面向家长沟通的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
