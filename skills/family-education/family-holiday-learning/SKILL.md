...
metadata:
  hermes:
    ...
    legacy_slugs: []
    install_aliases: ["family-holiday-learning"]
    ...
    requires_data: ["孩子年龄/年级", "假期长度、年级、薄弱点、家庭出行安排、每天可用学习时间", "今晚可用时间", "家长希望改善的一个具体问题", "可选：老师反馈、作业内容、孩子最近表现"]
---

# 假期家庭学习 Skill

假期家庭学习把寒暑假从“报很多课/放任玩”改成学习、阅读、运动和休息平衡的家庭节奏。重点不是替家长管孩子，而是把家庭学习场景拆成可沟通、可执行、可复盘的小步骤。
...
- 五年级暑假 6 周，数学弱、阅读少，帮我做一个能坚持的家庭计划。
- 请按假期家庭学习给我今晚能直接照着做的步骤和话术。
...
- Install Aliases: `family-holiday-learning`
- Stages: `preschool`, `primary`, `junior`
- Subjects: `家庭教育`
- Abilities: `陪学建议`
...
- Requires Data: `孩子年龄/年级`, `假期长度、年级、薄弱点、家庭出行安排、每天可用学习时间`, `今晚可用时间`, `家长希望改善的一个具体问题`, `可选：老师反馈、作业内容、孩子最近表现`
