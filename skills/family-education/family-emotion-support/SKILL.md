...
description: "学习情绪支持 Skill是面向亲子沟通的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。 Workflow: family_emotion_support.run."
version: "0.8.0"
author: zhongwei
license: MIT
...
学习情绪支持 Skill是面向亲子沟通的产品级 Hermes Skill，年级、册别、单元、知识点和难度通过参数传入。
