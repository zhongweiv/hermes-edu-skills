...
description: "高中英语写作 Skill用于写作提升、高考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: senior_english_writing.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "senior", "英语", "写作", "写作提升", "高考复习"]
...
高中英语写作 Skill用于写作提升、高考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。
