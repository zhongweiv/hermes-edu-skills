---
name: "junior-physics-foundation"
description: "初中物理 Skill用于同步巩固、中考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。 Workflow: junior_physics_foundation.run."
version: "0.1.0"
author: zhongwei
license: MIT
...
metadata:
  hermes:
    tags: ["education", "junior", "物理", "实验理解", "知识记忆", "同步巩固", "中考复习"]
    source: hermes-edu-skills
    workflow: "junior_physics_foundation.run"
    category: "physics"
    stages: ["junior"]
    subjects: ["物理"]
    abilities: ["实验理解", "知识记忆"]
...
初中物理 Skill用于同步巩固、中考复习，由 Hermes Agent Runtime 按独立 Agent Context 调用。
